...
class Environment(tk.Tk):
    ...
    def load_images(self):
        ...
        cheese = PhotoImage(Image.open("./cheese.jpg").resize((30, 30)))
        return mouse, cat, cheese
    ...
    def check_reward(self, state):
        ...
        for reward in self.rewards:
            if reward['state'] == state:
                ...
                if reward['reward'] == 1:
                    list['goal'] = True # mouse reached cheese
